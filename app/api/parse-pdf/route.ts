...
import { DEFAULT_TEXT_MODEL, isGeminiModel, resolveTextModel } from '@/lib/constants';
...
export async function POST(req: NextRequest) {
  try {
    ...
    const modelName = isGeminiModel(requestedModel) ? requestedModel : DEFAULT_TEXT_MODEL;
